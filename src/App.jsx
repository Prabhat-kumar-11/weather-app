...
function App() {
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-r from-teal-400 to-yellow-200 flex flex-col justify-center items-center  px-4 lg:px-0">
      {errorMsg && <div className=" w-full max-w-[90vw] lg:max-w-[450px] bg-[#6fe5f7]   absolute top-2  lg:top-10  p-4 capitalize rounded-md text-white">{`${errorMsg.response.data.message}`}</div>}
      <form
        className={`${
